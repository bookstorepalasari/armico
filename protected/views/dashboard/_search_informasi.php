<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
    ...
    <div class="row-fluid">
        <div class="col-md-6">
            ...
            <div class="form-group">
                <?php echo CHtml::activeLabel($model,'barcode',array('class'=>'col-sm-3  control-label')); ?>
                <div class="col-md-6">
                    <?php echo CHtml::activeTextField($model,'barcode',array('class'=>'span5 form-control','maxlength'=>50)); ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
