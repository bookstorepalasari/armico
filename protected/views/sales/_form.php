<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	'type'=>'horizontal',
	'focus' => '#msales-form div.form-group:first-child div input',
...
<div class="row">
    <!--<div class="form-group">-->
        <div style="text-align: center; margin-top:30px;">
            ...
            <?php echo $model->isNewRecord ? '&nbsp;&nbsp;'.CHtml::ResetButton('Reset', array('class' => 'btn btn-default')) : ''; ?><?php echo Chtml::link('Back',$this->createUrl('/sales/admin'), array('class' => 'btn btn-link')); ?>
        </div>
    <!--</div>-->
</div>
<?php $this->endWidget(); ?>