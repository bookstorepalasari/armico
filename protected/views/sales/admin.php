...
Yii::app()->clientScript->registerScript('search', "
    ...
    $('#pencarian').submit(function(){
        $.fn.yiiGridView.update('msales-grid', {
            data: $(this).serialize()
        });
        return false;
    });
...
<div class="col-md-4">
    <?php echo Chtml::link('<i class="entypo-plus"></i> Tambah',$this->createUrl('/sales/create'), array('class'=>'btn btn-flat btn-block btn-primary', 'style' => 'width: 100px; float:left;')); ?>
</div>    
	<div class="col-md-12">
