...
Yii::app()->clientScript->registerScript('search', "
    ...
    $('#pencarian').submit(function(){
        $.fn.yiiGridView.update('mgolongan-grid', {
            data: $(this).serialize()
        });
        return false;
    });
...
<div class="row">
    ...
    <div class="col-md-7">
        <?php // echo Chtml::link('<i class="entypo-plus"></i> Tambah',$this->createUrl('/golongan/create'), array('class'=>'btn btn-flat btn-block btn-primary', 'style' => 'width: 100px; float:left;')); ?>
    </div> 
</div>
<div class="row">
	<div class="col-md-12">
