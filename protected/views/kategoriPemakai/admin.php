...
<div class="row">
	...
	<div class="col-md-12">
		<?php echo Chtml::link('<i class="entypo-plus"></i> Tambah',$this->createUrl('/kategoriPemakai/create'), array('class'=>'btn btn-flat btn-block btn-primary', 'style' => 'width: 100px')); ?>		<?php $this->widget('booster.widgets.TbGridView',array(
