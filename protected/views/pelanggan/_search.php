...
?>
		...
		<?php echo $form->textField($model,'global_search',array('onKeyUp'=>'search(this)','value'=>$search,'class'=>'form-control','style'=>'width:30%; float:right;margin-right:10px;')); ?>
...
$(document).ready(function(){
     var search = $('#MPelanggan_global_search').val();
     if(search !== ''){
        $("#icon_search").attr('style','float:right; position: relative; margin-right:-300px; margin-top: 8px; display:block;');
    }else{
        $("#icon_search").attr('style','display:none;');
