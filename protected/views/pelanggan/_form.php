<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	'type'=>'horizontal',
	'focus' => '#mpelanggan-form div.form-group:first-child div input',
...
<div class="row">
    ...
    <div class="col-md-6">
	<?php echo $form->textFieldGroup($model,'telepon',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5 numbers-only','maxlength'=>100)))); ?>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <?php echo $form->textFieldGroup($model,'kode',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
	<?php echo $form->textAreaGroup($model,'alamat', array('widgetOptions'=>array('htmlOptions'=>array('rows'=>6, 'cols'=>50, 'class'=>'span5')))); ?>
    </div>
    <div class="col-md-6">
...
<div class="row">
    <!--<div class="form-group">-->
        <div style="text-align: center; margin-top:30px;">
            ...
            <?php echo $model->isNewRecord ? '&nbsp;&nbsp;'.CHtml::ResetButton('Reset', array('class' => 'btn btn-default')) : ''; ?><?php echo Chtml::link('Back',$this->createUrl('/pelanggan/admin'), array('class' => 'btn btn-link')); ?>
        </div>
    <!--</div>-->
</div>
<?php $this->endWidget(); ?>