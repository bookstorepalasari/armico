...
class EJuiMonthPicker extends CJuiInputWidget
{
	...
	public function init()
	{
		...
		$default_options = array(
			'monthNames' => array(
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Januari'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Februari'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Maret'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','April'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Mei'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Juni'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Juli'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Agustus'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','September'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Oktober'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Nopember'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Desember'),
			),
			'monthNamesShort' => array(
				...
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Agus'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Sep'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Okt'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Nop'),
				Yii::t('EJuiMonthPicker.EJuiMonthPicker','Des'),
			),
